# Tower Crane Load Stabilization Simulator
...
- **Physics engine** — linearized spherical pendulum with RK4 numerical integration (dt = 16 ms)
- **PID stabilizer** — independent X/Y axis controllers with tunable Kp, Ki, Kd gains
...
- **2D top-down view** — live load position, force vectors, and alarm circle
...
- Wind speed/direction sliders, wind impulse button, gusty wind mode
...
└── public/
    ...
    ├── sim.js         # Physics: Pendulum, PIDController, PropellerMixer classes
...
| Load mass | Cargo weight |
| Kp / Ki / Kd | PID gains — tune stabilizer response |
...
| Gusty wind | Enable random wind magnitude variations |
| ☀ LIGHT / ☾ DARK | Toggle UI theme |
